...
public class DigitalSmallImageClock extends RelativeLayout {
    private String TAG = "DigitalSmallImageClock";
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        public void onReceive(Context paramContext, Intent paramIntent) {
            if ("android.intent.action.TIMEZONE_CHANGED".equals(paramIntent
                ...
                DigitalSmallImageClock.this.createTime(str);
            }

            if (!("com.google.android.wearable.home.action.WEARABLE_TIME_TICK"
                    .equals(paramIntent.getAction()))) {
                DigitalSmallImageClock.this.holdWakelockUntilDrawn();
                DigitalSmallImageClock.this.onTimeChanged();
                DigitalSmallImageClock.this.postInvalidate();
            }
        }
    };
    ...
    public DigitalSmallImageClock(Context paramContext,
            AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        this.mContext = paramContext;
        this.mView = ((LayoutInflater) paramContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(
                R.layout.digital_image_small_clock_layout, this);
