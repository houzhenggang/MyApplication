...
import com.androidwear.home.watchfaces.ustwowatchfaces2.customstyle.DigitalTextClock;

public class BigBlackTextWatchFace extends Activity {
    private DigitalTextClock mClock;
    private boolean mRegistered;
    private final BroadcastReceiver mStateReceiver = new BroadcastReceiver() {
        public void onReceive(Context paramContext, Intent paramIntent) {
            if (!(paramIntent.hasExtra("ambient_mode")))
                return;
            BigBlackTextWatchFace.this.onAmbientModeChanged(paramIntent
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.activity_big_black_text_watch_face);
        this.mClock = ((DigitalTextClock) findViewById(R.id.compound_text_clock));
        registerReceiver();
    }
