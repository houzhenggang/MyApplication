...
public class SmallPopBlueAnalogWatchFace extends Activity {
    ...
    private final BroadcastReceiver mStateReceiver = new BroadcastReceiver() {
        public void onReceive(Context paramContext, Intent paramIntent) {
            if (!(paramIntent.hasExtra("ambient_mode")))
                return;
            SmallPopBlueAnalogWatchFace.this.onAmbientModeChanged(paramIntent
    ...
    protected void onAmbientModeChanged(boolean paramBoolean) {
        ...
        if (paramBoolean) {
            Drawable localDrawable2 = localResources.getDrawable(R.drawable.watch_modi_black_sub_bg);
            if (localDrawable2 != null)
                this.mBackgrounImage.setImageDrawable(localDrawable2);
        } else {
            Drawable localDrawable1 = localResources.getDrawable(R.drawable.watch_modi_blue_sub_bg);
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.activity_small_pop_blue_analog_watch_face);
