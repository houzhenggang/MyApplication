...
/* Innova:fengchuan on: Tue, 27 May 2014 19:29:41 +0800
 * TODO: replace this line with your comment
  */
    public static boolean WKTSUPPORT = SystemProperties.getBoolean("ro.support.wkt138",false);
...
/* Innova:fengchuan on: Tue, 27 May 2014 19:30:11 +0800
 * TODO: replace this line with your comment *
  ...
  */
        if(WKTSUPPORT && getScrollY() < getHeight() - (mUnlockblockHeight / 2 + 60)
                    && mIsInUnlockArea){
                return true;
        } else if (getScrollY() < getHeight() - (mUnlockblockHeight / 2)
                && mIsInUnlockArea) {
            return true;
                }
// End of Innova:        * fengchuan*
