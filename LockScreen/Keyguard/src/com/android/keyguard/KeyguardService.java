...
public class KeyguardService extends Service {
    ...
    private final IKeyguardService.Stub mBinder = new IKeyguardService.Stub() {
        ...
        //-------------------------------yunlan start---------------------------------------
        public boolean isYLUnlockNeedScreenShot() {
        	return mIsNeedScreenShot;
        }
        public boolean isInLockState() {
        	return mIsInLockState;
        }
        public void setYLUnlockBG(Bitmap bg) {
        	Log.i("sam", "setYLUnlockBG bg ==="+bg);
        	Log.i("sam", "setYLUnlockBG mYLBGBitmap===="+mScreenShotBmp);
        	mScreenShotBmp = bg;
        }
        //-------------------------------yunlan end----------------------------------------
    };
	 ...
	 //-------------------------------yunlan start---------------------------------------
	private static Bitmap mScreenShotBmp = null;
	private static boolean mIsInLockState = true;
	private static boolean mIsNeedScreenShot = true;
 	public static Bitmap getScreenShotBmp() {
		return mScreenShotBmp;
	}
	
	public static void setLockState(boolean bLockState) {
		mIsInLockState = bLockState;
	}
	
	public static void setNeedScreenShot(boolean nNeedScreenShot) {
		mIsNeedScreenShot = nNeedScreenShot;
	}
	 //-------------------------------yunlan end---------------------------------------
}
