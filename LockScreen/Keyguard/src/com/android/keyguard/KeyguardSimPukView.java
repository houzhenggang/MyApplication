...
public class KeyguardSimPukView extends KeyguardAbsKeyInputView
        implements KeyguardSecurityView,IKeguardLockView, OnEditorActionListener, TextWatcher {
    ...
    private class StateMachine {
        ...
        void reset() {
            ...
            mPukText="";
            state = ENTER_PUK;
            /* SPRD: modify for bug255598 to add simid @{ */
            String msg = "";
            if(TelephonyManager.isMultiSim()){
                msg = mContext.getResources().getString(com.android.internal.R.string.kg_puk_enter_puk_hint_sub,mSubId+1,mRemainTimes);
            }else{
                msg = mContext.getResources().getString(R.string.kg_puk_enter_puk_hint)+"("+mRemainTimes+")";
            }
            /* @} */
            mSecurityMessageDisplay.setMessage(msg, true);
    ...
    protected void onFinishInflate() {
        ...
        /* SPRD: Modify 20140110 Spreadst of Bug 256008 add cancel for sim pin and puk @{ */
        final View cancel = findViewById(R.id.key_sim_puk_cancel);
        if (cancel != null) {
            cancel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    doHapticKeyClick();
                    KeyguardUpdateMonitor.getInstance(getContext()).updateSimPukUnlockCancel(mSubId);
    ...
    private abstract class CheckSimPuk extends Thread {
        ...
        public void run() {
            try {
                ...
                /* SPRD: Modify 20140110 Spreadst of Bug 266636  multi-card sim2 puk fail @{ */
                final int[] result = ITelephony.Stub.asInterface(ServiceManager
                        .checkService(TelephonyManager.getServiceName(Context.TELEPHONY_SERVICE, mSubId))).supplyPukReportResult(mPuk, mPin);
                /* @} */
                    ...
                    post(new Runnable() {
                        public void run() {
                            ...
                            if (result == PhoneConstants.PIN_RESULT_SUCCESS) {
                                // SPRD: SPRD: Modify 20140120 Spreadst of Bug 271459 no sim pin verify success top
                                Toast.makeText(mContext, mContext.getResources().getString(R.string.kg_sim_pin_verify_success), Toast.LENGTH_SHORT).show();
                                // SPRD: Modify 20140110 Spreadst of Bug 266636  multi-card sim2 puk fail
                                KeyguardUpdateMonitor.getInstance(getContext()).reportSimUnlocked(mSubId);
                                mCallback.dismiss(true);
                            } else {
                                // SPRD: modify for bug257585
